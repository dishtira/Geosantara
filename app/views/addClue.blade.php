...
<div class="col-md-4">
	<form action="{{ URL::route('postAddClue') }}" method="post" >
		<div class="form-group @if ($errors->has('clueid')) has-error @endif">
            <label>Clue ID</label>
            <input type="hidden" name="clueID" value="{{ $clueID }}"/>
            <input class="form-control" placeholder="ClueID" value="{{ $clueID }}" disabled="" />
        ...
        <div class="form-group @if ($errors->has('clue')) has-error @endif">
            <label>Clue</label>
            <textarea class="form-control" placeholder="Clue" name="clue">{{ (Input::old('clue')) ? e(Input::old('clue')) : '' }}</textarea>
        ...
        <div class="form-group @if ($errors->has('answer')) has-error @endif">
            <label>Answer</label>
            <textarea class="form-control" placeholder="Answer" id="answer" name="answer">{{ (Input::old('answer')) ? e(Input::old('answer')) : '' }}</textarea>
